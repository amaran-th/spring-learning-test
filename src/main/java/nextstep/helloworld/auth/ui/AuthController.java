...
public class AuthController {
     ...
     * ex) request sample
     * <p>
     * POST /login/session HTTP/1.1 content-type: application/x-www-form-urlencoded;
     * charset=ISO-8859-1 host: localhost:55477
     * <p>
     * email=email@email.com&password=1234
     */
    @PostMapping("/login/session")
    public ResponseEntity sessionLogin(@RequestParam String email, @RequestParam String password,
     ...
     * ex) request sample
     * <p>
     * GET /members/me HTTP/1.1 cookie: JSESSIONID=E7263AC9557EF658C888F02EEF840A19 accept:
     * application/json
     */
     ...
     * ex) request sample
     * <p>
     * POST /login/token HTTP/1.1 accept: application/json content-type: application/json;
     * charset=UTF-8
     * <p>
     * { "email": "email@email.com", "password": "1234" }
     */
     ...
     * ex) request sample
     * <p>
     * GET /members/my HTTP/1.1 authorization: Basic ZW1haWxAZW1haWwuY29tOjEyMzQ= accept:
     * application/json
     */
    @GetMapping("/members/my")
    public ResponseEntity findMyInfos(HttpServletRequest request) {
        // TODO: authorization 헤더의 Basic 값을 추출하기
        String credentials = request.getHeader("authorization").substring("Basic ".length());
        String decoded = new String(Base64Utils.decode(credentials.getBytes()));
